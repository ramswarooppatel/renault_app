...
interface VehicleHook {
  vehicle: Vehicle;
  setVehicleState: (state: Vehicle) => void;
}

const ClimateScreen = () => {
  const { vehicle, setVehicleState } = useVehicle() as VehicleHook;
  ...
  const handleModeChange = (mode: 'face' | 'face-feet' | 'feet' | 'face-defrost') => {
    setVehicleState({
      ...vehicle,
      climate: {
        ...vehicle.climate,
  ...
  const handlePresetSelect = (preset: string) => {
    ...
    switch(preset) {
      case 'defrost':
        newSettings = { ...newSettings, temperature: 24, fanSpeed: 4, mode: 'face-defrost', isAcOn: true };
        break;
      case 'comfort':
        newSettings = { ...newSettings, temperature: 22, fanSpeed: 2, mode: 'face', isAcOn: true };
        break;
      case 'eco':
        newSettings = { ...newSettings, temperature: 23, fanSpeed: 1, mode: 'face', isAcOn: false };
        break;
      case 'max':
        newSettings = { ...newSettings, temperature: 18, fanSpeed: 4, mode: 'face', isAcOn: true };
        break;
    }
